        ...
        <div className="container-fluid my-5">
          <div className="row justify-content-center">
            <div className="col-lg-10 col-md-12">
              <div className="card mb-3 mx-auto" style={{ backgroundColor: 'transparent', border: 'none' }}>
                <div className="card-body" style={{ backgroundColor: 'transparent', padding: '3rem 1rem' }}>
                  <h1 className="card-title text-center mb-5" style={{ fontSize: '5rem', fontWeight: 'bold', color: '#FFD824' }}>Cookies</h1>
