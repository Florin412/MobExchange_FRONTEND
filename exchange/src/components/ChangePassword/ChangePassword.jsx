                ...
                <form className="row g-3" onSubmit={submitForm}>
                    ...
                    <div className="mb-5 text-start">
                        <div className="col-md-12 mb-5">
                            ...
                            />
                            {currentPasswordError && <div className="fs-3 error-message text-danger">{currentPasswordError}</div>}
                        </div>
                        <div className="col-md-12 mb-1">
                            ...
                            />
                            {newPasswordError && <div className="fs-3 error-message text-danger">{newPasswordError}</div>}
                        </div>
                        <div className="col-md-12 mb-1">
                            ...
                            />
                            {confirmPasswordError && <div className="fs-3 error-message text-danger">{confirmPasswordError}</div>}
                        </div>
                    </div>
